...
class Vanilla_AudioMAE(nn.Module):
    ...
    def __init__(self,):
        ...
        checkpoint_path = '/mnt/fast/nobackup/scratch4weeks/yy01071/audioLDM2/audio_generation_diffusion-main/model_logs/pre-trained/mae.pth'
        checkpoint = torch.load(checkpoint_path, map_location='cpu')
        msg = model.load_state_dict(checkpoint['model'], strict=False)
    ...
    def forward(self, x, mask_ratio=0.0, no_mask=False):
        """
